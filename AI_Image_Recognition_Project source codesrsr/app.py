...
USERS_TABLE = 'users'
USER_RESULTS_TABLE = 'user_results'  # Changed from USER_ANSWERS_TABLE
...
def create_tables():
    ...
    try:
        dynamodb.create_table(
            TableName=USER_RESULTS_TABLE,  # Changed from USER_ANSWERS_TABLE
...
def analyze_image():
    ...
    try:
        ...
        table = dynamodb.Table(USER_RESULTS_TABLE)  # Changed from USER_ANSWERS_TABLE
        table.put_item(
            Item={
